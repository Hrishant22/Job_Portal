  ...
  return (
      <div className='container p-4 max-w-5xl'>
        <div className='overflow-x-auto'>
          <table className='min-w-full bg-whiter border border-gray-200 max-sm:text-sm'>
          <thead>
            <tr>
              <th className='py-2 px-4 border-b border-gray-200  text-lef max-sm:hidden'>#</th>
        ...
        <div className='mt-4 flex justify-end'>
          <button onClick={(e) => navigate('/dashboard/add-job')} className='bg-emerald-700 text-white py-2 px-2 rounded cursor-pointer'>Add New Job</button>
        </div>
